 ...
 *
 *********************************************************************/
static void USI0RX_ISR (void) interrupt USI0_RX_VECT  
{
 ...
 *
 *********************************************************************/
static void USI0TX_ISR (void) interrupt USI0_TX_VECT
{
...
void DBG_Send_Data(void)
{
    uint8_t i;
    uint8_t end_idx;
    uint8_t len;            /* Keil:Optimization - Level 7AI��o�������� i ��I A����� */
    uint8_t shift_bit;
    uint8_t mask_cnt;
