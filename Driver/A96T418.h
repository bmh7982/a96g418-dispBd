...
#define POL0_NO_INT     ((INT8U)0x00) 	/*!< EIPOL0L[1:0]
                                        ...
                                        00 : No interrupt at any edge
                                        */
#define POL0_RIS_ADGE   ((INT8U)0x40) 	/*!< EIPOL0L[1:0]
                                        EINT0 polarity selection
                                        01 : Interrupt on rising edge
                                        */    
#define POL0_FAL_ADGE   ((INT8U)0x80) 	/*!< EIPOL0L[1:0]
                                        EINT0 polarity selection
                                        10 : Interrupt on falling edge
                                        */    
#define POL0_BOTH_ADGE  ((INT8U)0xC0) 	/*!< EIPOL0L[1:0]
                                        EINT0 polarity selection
                                        11 : Interrupt on both of rising and falling edge
                                        */                                
//------------------------------------------------------------------------------
...
#define POL4_NO_INT     ((INT8U)0x00) 	/*!< EIPOL0H[1:0]
                                        ...
                                        00 : No interrupt at any edge
                                        */
#define POL4_RIS_ADGE   ((INT8U)0x40) 	/*!< EIPOL0H[1:0]
                                        EINT4 polarity selection
                                        01 : Interrupt on rising edge
                                        */    
#define POL4_FAL_ADGE   ((INT8U)0x80) 	/*!< EIPOL0H[1:0]
                                        EINT4 polarity selection
                                        10 : Interrupt on falling edge
                                        */    
#define POL4_BOTH_ADGE  ((INT8U)0xC0) 	/*!< EIPOL0H[1:0]
                                        EINT4 polarity selection
                                        11 : Interrupt on both of rising and falling edge
                                        */  
//------------------------------------------------------------------------------
...
#define POL8_NO_INT     ((INT8U)0x00) 	/*!< EIPOL1[1:0]
                                        ...
                                        00 : No interrupt at any edge
                                        */
#define POL8_RIS_ADGE   ((INT8U)0x40) 	/*!< EIPOL1[1:0]
                                        EINT8 polarity selection
                                        01 : Interrupt on rising edge
                                        */    
#define POL8_FAL_ADGE   ((INT8U)0x80) 	/*!< EIPOL1[1:0]
                                        EINT8 polarity selection
                                        10 : Interrupt on falling edge
                                        */    
#define POL8_BOTH_ADGE  ((INT8U)0xC0) 	/*!< EIPOL1[1:0]
                                        EINT8 polarity selection
                                        11 : Interrupt on both of rising and falling edge
                                        */  
//------------------------------------------------------------------------------
...
#define PEVBSY      ((INT8U)0x80)   /*!< FESR[7]
                                    ...
                                    1 : No operation (default)
                                    */
#define REMAPSI     ((INT8U)0x40)   /*!< FESR[6]
